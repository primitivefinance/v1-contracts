...
library OptionTemplateLib {
    ...
    bytes32 private constant _OPTION_SALT = 0x56f3a99c8e36689645460020839ea1340cbbb2e507b7effe3f180a89db85dd87; // keccak("primitive-option")
    ...
    /**
     * @dev Deploys Option.sol with create2.
     */
