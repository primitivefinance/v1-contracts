...
const OPTION_SALT = ethers.utils.solidityKeccak256(['string'], ['primitive-option']);
const OPTION_INITCODEHASH = ethers.utils.solidityKeccak256(['bytes'], [ Option.bytecode ]);
...
const computeOptionAddress = ({
  ...
  return ethers.utils.getCreate2Address({
    ...
    initCodeHash: ethers.utils.arrayify(ethers.utils.solidityKeccak256([ 'bytes' ], [ assembleCloneCode(factory, implementation) ]))
  });
};
